...
![실행화면](img/7.2.png)
-구현한내용(위그림참조)-파일 이름에 색상 추가하여 파일의 상태를 시각적으로 구분할 수 있도록 구현하였습니다. 
  예를 들어, 동일한 파일은 검은색으로 표시되고, 다른 파일은 빨간색으로 표시되도록 하였습니다. 
  이를 통해 사용자가 파일의 상태를 한눈에 파악할 수 있도록 도와줍니다
## 실행화면(과제3)-코드의실행스크린샷과구현내용설명
![실행화면](img/7.3.png)
![실행화면](img/7.4.png)
![실행화면](img/7.5.png)
-구현한내용(위그림참조)-버튼을 눌러 다른 폴더로 파일을 이동할 수 있도록 구현하였습니다. 
  사용자가이동하려는파일을선택하고, 이동버튼을클릭하면파일이선택한폴더로이동됩니다. 
  이를통해사용자는폴더간에파일을쉽게관리할수있도록도와줍니다.
## 실행화면(과제4)-코드의실행스크린샷과구현내용설명
![실행화면](img/7.6.png)
![실행화면](img/7.7.png)
![실행화면](img/7.8.png)
-구현한내용(위그림참조)-파일도 움직이게 변경함
